...
time g++ -fmax-errors=1 $BUILD_MODE -std=c++20 -Wall -Wextra -Wpedantic -Wno-volatile -fno-rtti -I../EventBot/src/ $MONGOOSE_OPTS src/mongoose.c src/main.cpp $LIBS -o http_api_server
